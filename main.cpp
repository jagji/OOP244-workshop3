...

{
    ...
    if 
        ...
        (!customer.isEmpty() && !customer.car().isEmpty()) 
...

{
    ...
    cars[0].set("ABC123", nullptr, "Engine oil change", 50.0);
    // invalid



    cars[1].set("ABC1234", "Toyota Camry", nullptr, 50.0);  
    
    // invalid
    cars[2].set("DEFG1234", "", "Air filter change", 9.0);   
    
    // invalid
    cars[3].set("ABC", "Toyota Camry", "", 50.0);           
    
    // invalid
    cars[4].set("ABC", "Toyota Camry", "Engine oil change", 50.0); 
    
    // valid

    for
        (int i = 0; i < numOfCustomers + 1; i++) 
    {
